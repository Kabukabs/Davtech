...
export default function SkillCollab() {
  ...
  return (
    ...
    <form onSubmit={ submitForm }  enctype= "multipart/form-data" class="w-full max-w-[800px]">
      <div >
        <h2 className=" font-bold text-darkblue mb-6 text-[40px]">SKILLFUL COLLABORATION</h2>
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <label class="block text-darkblue  md:text-right mb-1 md:mb-0 text-[15px] " for="inline-name">
        ...
        <label class="block text-darkblue  md:text-right mb-1 md:mb-0 text-[15px] " for="inline-email">
        <span className="text-red-500">*</span>
          Email:
          </label>
        ...
        <label class="block text-darkblue  md:text-right mb-1 md:mb-0 text-[15px] " for="inline-phone">
        <span className="text-red-500">*</span>
          Phone:
          </label>
        ...
        <label class="block text-darkblue  md:text-right  mb-2 text-[15px] " for="inline-experience">
        <span className="text-red-500">*</span>
          Experience:
          </label>
          ...
          <textarea
            ...
            required
            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight ml-6 mt-10 focus:outline-none focus:bg-white focus:border-purple-500"  id="inline-experience"
            rows="5" cols="50"
          />
          </div>
       </div>
       ...
       <label class="block text-darkblue  md:text-right mb-1 md:mb-0 text-[15px] " for="inline-cv">
          CV Upload
          <input
